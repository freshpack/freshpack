...
Usage: freshpack <project-directory> [options]
  ...
  Options:
    ...
    -r, --redux     add redux files and configuration
    -s, --sass      add sass support
    -t, --test      add tests with jest
    -l, --lint      add linting with eslint
    -a, --all       alias for '--redux --scss --lint --test'
`;
